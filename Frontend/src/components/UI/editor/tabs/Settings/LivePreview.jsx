...
const LivePreview = ({ portfolio, onShowFullPreview, primaryColor, secondaryColor, template }) => {
  ...
  // Custom style values for theme colors
  const themeStyles = {
    '--theme-primary': primaryColor || '#F4A6B5',
    '--theme-secondary': secondaryColor || '#E8B4B8',
  };
  ...
  return (
    <div className="settings-section live-preview-section">
      ...
      <div className="live-preview-card" style={themeStyles}>
        <div className={`preview-body preview-body--${template || 'modern'}`}>
          ...
          {(socialLinks.github || socialLinks.linkedin) && (
            <div className="preview-socials">
              {socialLinks.github && (
                <a href={socialLinks.github} target="_blank" rel="noopener noreferrer" className="preview-social-icon">
              ...
              {socialLinks.linkedin && (
                <a href={socialLinks.linkedin} target="_blank" rel="noopener noreferrer" className="preview-social-icon">
