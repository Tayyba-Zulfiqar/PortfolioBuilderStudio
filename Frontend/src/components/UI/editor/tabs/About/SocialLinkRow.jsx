...
const socialIcons = {
    ...
    youtube: {
        ...
        className: 'social-link-icon--youtube',
        placeholder: 'https://youtube.com/@username',
    },
};

const SocialLinkRow = ({ name, register, error }) => {
    const social = socialIcons[name];
    if (!social) return null;

    return (
        <div className="social-link-row">
            <div className={`social-link-icon ${social.className}`}>
                {social.icon}
            </div>
            <input
                type="url"
